...
public class ClothesArmorItem extends TaskmodModElements.ModElement {
	@ObjectHolder("taskmod:clothes_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("taskmod:clothes_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("taskmod:clothes_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("taskmod:clothes_armor_boots")
	public static final Item boots = null;
	public ClothesArmorItem(TaskmodModElements instance) {
		super(instance, 41);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(LeatherFabricItem.block, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			public String getName() {
				return "clothes_armor";
			}
